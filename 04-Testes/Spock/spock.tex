...
\begin{frame}{Spock Framework}
 \begin{outline}
   ...
   \1<2-> Para aplicações Java e Groovy
   \1<3-> Baseado em Groovy
...
\begin{frame}{Objetivos}
 \begin{outline}
   ...
   \1<3-> Testes $\rightarrow$ Especificações
   \1<4-> Extensível
   \1<5-> Especificações como documentação
 \end{outline}
\end{frame}
...
\begin{frame}{State Based Testing}
 \begin{outline}
   ...
   \1<2-> Testes clássicos:
    \2<2-> Arranjar
    \2<2-> Agir
    \2<2-> Verificar (Assert)
   \1<3-> Given-When-Then
 \end{outline}
\end{frame}
...
\begin{frame}{Blocos de Estímulo e Resposta}
 \begin{outline}
   ...
   \1<3-> \alert{then:}
    ...
    \2<4-> Restrito a condições, interações e definições de variável
   \1<5-> \alert{expect:}
...
\begin{frame}{Data Driven Testing}
 \begin{outline}
   \1<1-> Testa o mesmo comportamento com dados variáveis
   \1<2-> O mesmo teste é executado múltiplas vezes
...
\begin{frame}{Conclusões}
 \begin{outline}
   ...
   \1<3-> Documentação de especificações
 \end{outline}
\end{frame}
